...
local UPDATE_PATH      = "/gnomgrol/BeatenByALittleGirl/master/beatenByALittleGirl.lua"
local VERSION_PATH     = "/gnomgrol/BeatenByALittleGirl/master/beatenByALittleGirl.version"
local UPDATE_FILE_PATH = SCRIPT_PATH..GetCurrentEnv().FILE_NAME
local UPDATE_URL       = "https://"..UPDATE_HOST..UPDATE_PATH
local SCRIPT_NAME      = "Beaten by a little girl"
